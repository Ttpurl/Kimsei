...
clear
echo "Your Tor proxy is set up! Using a proxy tool, use this machine's IP address along with port $torproxport. Remember to use UFW when administering the firewall!"