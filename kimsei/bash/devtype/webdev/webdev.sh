...
echo "records (A/AAAA) ready and assigned to this server before running."
echo "##################################################################"
echo "3. Apache Web Server (No SSL)"
echo "This script will set up an HTTP Apache web server that can be deployed on a local network,"
echo "or a VPS. This will not set up SSL and will ask you for a domain name to use"
echo "##################################################################"
echo "4. Nginx Web Server (No SSL)"
echo "This script will set up an HTTP Nginx web server that can be deployed on a local network,"
echo "or a VPS. This will not set up SSL and will ask you for a domain name to use"
echo "##################################################################"
echo "5. "
echo "6. "
